...
#
#   Tester: INIT - data, encode+test | IN - population | OUT - fitness
#   Picker: INIT - | IN - population, fitness | OUT - best population
#   Builder: INIT - methods | IN - population | OUT - new population
